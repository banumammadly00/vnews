        ...
        <div class="vmagazine-breadcrumb-wrapper ">
            <div class="vmagazine-bread-home">
                <div class="vmagazine-bread-wrapp vmagazine-container">
                    <div class="breadcrumb-title"><h1 class="page-title">News</h1> </div>
                    <div class="vmagazine-breadcrumb"><nav role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                            <ul class="trail-items">
                                ...
                                <li class="trail-item"><a href="{{ route('category.index', $category->sub_category) }}"><span>{{ $category_name( $category->sub_category ) }}</span></a></li>
                                @endif
                                <li class="trail-item"><a href="{{ route('category.index', $category->id) }}"><span>{{ $category_name($category->id) }}</span></a></li>
                                 {{--<li class="trail-item trail-end current"><span>News</span></li>--}}
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div id="panel-38-5-0-0" class="so-panel widget widget_vmagazine_block_grid_list vmagazine_block_grid_list panel-first-child panel-last-child" data-index="15">
                        <div class="panel-widget-style panel-widget-style-for-38-5-0-0">
                            <div class="block-header clearfix">
                                <h4 class="block-title"><span class="title-bg">  {{ $category->name }}   </span></h4>
                            </div><!-- .block-header-->
